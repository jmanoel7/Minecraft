...
from pyglet.gl import (GL_CULL_FACE, GL_DEPTH_TEST, GL_DONT_CARE, GL_FILL,
                       ...
                       GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER, GLfloat,
                       glClearColor, glColor3d, glDisable, glEnable, glFogf,
                       glFogfv, glFogi, glHint, glLoadIdentity, glMatrixMode,
                       glOrtho, glPolygonMode, glRotatef, glTexParameteri,
                       glTranslatef, gluPerspective, glViewport)
...
TEXTURE_PATH = '/home/joaomanoel/src/Minecraft/texture.png'
...
class Window(pyglet.window.Window):
    ...
    def get_sight_vector(self):
        ...
        # and is 1 when looking ahead parallel to the ground and 0 when
    ...
    def draw_label(self):
        ...
        self.label.text = '%02d (%.2f, %.2f, %.2f) %d / %d' % (
            pyglet.clock.get_fps(), x, y, z, len(self.model._shown),
